...
CREATE TABLE IF NOT EXISTS simulacrum.financial_institution_identification_code (
  id SMALLINT PRIMARY KEY,
  code VARCHAR(16) UNIQUE NOT NULL
);
INSERT INTO simulacrum.financial_institution_identification_code (id, code) VALUES
  (1, 'BIC'), (2, 'LEI')
ON CONFLICT DO NOTHING;

CREATE TABLE IF NOT EXISTS simulacrum.account_identification_code (
  id SMALLINT PRIMARY KEY,
  code VARCHAR(16) UNIQUE NOT NULL
);
INSERT INTO simulacrum.account_identification_code (id, code) VALUES
