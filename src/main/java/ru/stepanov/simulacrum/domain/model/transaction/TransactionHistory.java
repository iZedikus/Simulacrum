...
public class TransactionHistory {
    ...
    public TransactionHistory(String transactionId, String accountId, TransactionStatusCode status, BankTransactionCode bankTransactionCode, Instant bookingDateTime, Instant valueDateTime, Money chargeAmount, CreditDebitCode creditDebitIndicator, String merchantName, String merchantId, Integer mccCode, String debtorName, String creditorName) {
        this.transactionId = transactionId; this.accountId = accountId; this.status = status; this.bankTransactionCode = bankTransactionCode;
        this.bookingDateTime = bookingDateTime; this.valueDateTime = valueDateTime; this.chargeAmount = chargeAmount; this.creditDebitIndicator = creditDebitIndicator;
        this.merchantName = merchantName; this.merchantId = merchantId; this.mccCode = mccCode; this.debtorName = debtorName; this.creditorName = creditorName;
    }
    ...
    public String getTransactionId(){return transactionId;} public String getAccountId(){return accountId;} public TransactionStatusCode getStatus(){return status;} public BankTransactionCode getBankTransactionCode(){return bankTransactionCode;} public Instant getBookingDateTime(){return bookingDateTime;} public Instant getValueDateTime(){return valueDateTime;} public Money getChargeAmount(){return chargeAmount;} public CreditDebitCode getCreditDebitIndicator(){return creditDebitIndicator;} public String getMerchantName(){return merchantName;} public String getMerchantId(){return merchantId;} public Integer getMccCode(){return mccCode;} public String getDebtorName(){return debtorName;} public String getCreditorName(){return creditorName;} public String getFailureCode(){return failureCode;} public String getFailureMessage(){return failureMessage;}
}
